...
const QRUsers = require('../models/QRUsersSchema');
...
const getCurrentUserData = async (req, res) => {
    try {
        ...
        // Always return "Not specified" for current user creation - no location data
        let hotelAddress = 'Not specified';
        let hotelCoordinates = null;
        let busAddress = 'Not specified';
        let busCoordinates = null;

        console.log('🔍 [CURRENT_USER_DATA] Returning "Not specified" for current user creation');

        // Set final addresses to "Not specified"
        let finalHotelAddress = 'Not specified';
        let finalBusAddress = 'Not specified';
        ...
        const responseData = {
            ...
            hotelName: finalHotelAddress,
            hotelCoordinates,
            busAddress: finalBusAddress,
            busName: finalBusAddress,
            busCoordinates,
    ...
    try {
      ...
      `);
        ...
        console.log('🔍 [QR_HTML] Data for HTML generation:', {
            ...
            roomNo: qrUser.roomNo,
            phone: qrUser.phone,
            hotelName: qrUser.hotelAddress,
            hotelAddress: hotelAddress,
            busName: qrUser.busAddress,
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <div class="phone">📞 ${qrUser.phone || 'Not specified'}</div>
          ...
          <div class="contact-info">
            <div class="info-item">
              ...
              <div class="info-content">
                ...
                <div class="info-value">${qrUser.phone || 'Not specified'}</div>
              </div>
            </div>
            ...
            <div class="info-item">
              ...
              <div class="info-content">
                ...
                <div class="info-value">${qrUser.hotelAddress || hotelAddress}</div>
            ...
            <div class="info-item">
              ...
              <div class="info-content">
                ...
                <div class="info-value">${qrUser.busAddress || busAddress}</div>
